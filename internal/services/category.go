...
func (s *CategoryService) UpdateProductCategory(ctx context.Context, categoryID int, req models.ProductCategory) error {
	...
	if err != nil {
		return errors.Wrap(err, "failed to marhsal di request")
	}
...
func (s *CategoryService) GetCategory(ctx context.Context) ([]models.ProductCategory, error) {
	return s.CategoryRepo.GetCategory(ctx)
}
